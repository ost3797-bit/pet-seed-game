...
function Process-NewChar2ToChar1($inPath, $outPath) {
    Write-Host "Processing transparent $inPath -> $outPath with exact Bottom & Center alignment..."
    ...
    Write-Host "Successfully replaced and saved to $outPath without losing white color details!"
}

$dir = "c:\Users\a\Desktop\godot-engine-4-x-scene-gdscript\outputs\PetSeedGame\assets\characters"
Process-NewChar2ToChar1 "$dir\character_2.png" "$dir\character_1.png"
